...
export class MemStorage implements IStorage {
  ...
  async updateBrand(id: number, brand: Partial<Brand>): Promise<Brand | undefined> {
  ...
  // async getParentByStudent(studentId: number): Promise<Parent | undefined> {
  //   return Array.from(this.parentsMap.values()).find(
