...
const transportationModeFormSchema = z.object({
  ...
  // perDayValue: z.number().min(1, "Per day value must be greater than 0"),
  perDayValue: z.number({
    required_error: "Per day value is required",
    invalid_type_error: "Per day value must be a number",
  }).min(0.01, "Per day value must be at least 0.01"),
...
export default function BranchAdminCourses() {
  ...
  const handleEditBatch = (batch: any) => {
    ...
    editBatchForm.reset({
      ...
      //   duration: s.duration,
      // })),
      schedules: Array.isArray(batch.schedules)
  ...
  return (
    <AppShell>
      <PageHeader
        ...
        description="Manage brands,  branches, departments, courses, batches, and schedules offered by jazzrockers."
        actions={
          <Button
            onClick={() => {
