...
export default function AdminMessages() {
  ...
  const conversations = [
    {
      ...
      lastMessage: "I've updated the attendance for today's class.",
    ...
    },
    {
      ...
      lastMessage: "Will my daughter be able to perform in the upcoming recital?",
    ...
    },
    {
      ...
      lastMessage: "I need to reschedule tomorrow's vocal class.",
    ...
    },
    {
      ...
      lastMessage: "The dance hall needs maintenance.",
    ...
    },
    {
      ...
      lastMessage: "Can I get a receipt for last month's payment?",
    ...
    },
    {
      ...
      lastMessage: "I won't be able to attend tomorrow's class.",
  ...
  const messageHistory = [
    {
      ...
      conversationId: 1,
      sender: "John Smith",
      content: "Hello! I wanted to update you about today's guitar class.",
      timestamp: new Date(Date.now() - 1000 * 60 * 30), // 30 minutes ago
      isMe: false
    },
    {
      ...
      conversationId: 1,
      sender: "Me",
      content: "Hi John, sure. What's the update?",
    ...
    },
    {
      ...
      conversationId: 1,
      sender: "John Smith",
      content: "We had full attendance today except for Aarav, who called in sick.",
    ...
    },
    {
      ...
      conversationId: 1,
      sender: "Me",
      content: "Thank you for letting me know. I hope Aarav feels better soon.",
    ...
    },
    {
      ...
      conversationId: 1,
      sender: "John Smith",
      content: "I've updated the attendance for today's class in the system.",
    ...
    },
    {
      ...
      conversationId: 1,
      sender: "John Smith",
      content: "Also, a few students have shown interest in the advanced guitar workshop. Should we plan something for next month?",
      timestamp: new Date(Date.now() - 1000 * 60 * 5), // 5 minutes ago
      isMe: false
    }
  ];
  ...
  const filteredConversations = conversations
    .filter(conversation => {
      ...
      if (activeTab === "parents" && conversation.role !== "Parent") {
        return false;
      }
      if (activeTab === "students" && conversation.role !== "Student") {
        return false;
      }
  ...
  return (
    <AppShell>
      <PageHeader 
        title="Messages" 
        description="Communicate with teachers, parents, and students"
      />
