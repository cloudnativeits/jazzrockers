        ...
        <div className="flex items-center">
          ...
          <div className="flex items-center">
            <div className="h-10 w-10 bg-white rounded-full flex items-center justify-center mr-2 shadow-sm">
              <img src="/jazzLogo.jpeg" alt="Jazzrockers Logo" className="h-9 w-9 object-contain" />
            </div>
        ...
        <div className="flex items-center">
          <div className="relative mr-4">
            ...
            {/* {user?.role === "parent" && (
              ...
              >
                <button className="p-2 rounded-full hover:bg-neutral-100">
                  <FaWhatsapp className="h-9 w-9 text-green-600" />
                </button>
              </a>
            )} */}
            {/* {user?.role === "parent" && (
              <div className="flex items-center">
                ...
                >
                  <FaGlobe className="h-9 w-9 text-neutral-600" />
                </a>
                <a
                  href="https://wa.link/d94ig5"
                  target="_blank"
